def getthing():
    thing = []
    with open("./2021/4/example.txt", "r") as f:
...
def PartOne():
    ...
    print("PartOne")
    print(
        "Card {} is the winner with result {} and the winning num {}".format(
            card, result, getNumbers(getthing())[time]
        )
    )
...
def PartTwo():
    ...
    print("PartTwo")
    print(
        "Card {} is the loser with result {} and the winning num {}".format(
            card, result, getNumbers(getthing())[time]
        )
    )
