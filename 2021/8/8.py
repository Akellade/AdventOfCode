        ...
        while len(newchars) < 10:
            for s in signals[i]:
                if len(s) == 2:
                    ...
                    try:
                        thing = "".join(
                            sorted(set(newchars[4]).intersection((sorted(s))))
                        )
                        thing2 = "".join(sorted(s))
                        if (
                            "".join(sorted(set(newchars[4]).intersection((sorted(s)))))
                            == newchars[4]
                        ):
                            newchars[9] = "".join(sorted(s))
                        elif (
                            "".join(sorted(set(newchars[1]).intersection((sorted(s)))))
                            == newchars[1]
                        ):
                    ...
                    try:
                        ...
                        if "".join(
                            sorted(set(newchars[9]).intersection((sorted(s))))
                        ) == "".join(sorted(s)):

                            if (
                                len(sorted(set(newchars[6]).intersection((sorted(s)))))
                                == 5
                            ):
        ...
        for c in chars[i]:
            result.append(
                str(
                    [
                        key
                        for key, item in newchars.items()
                        if item == "".join(sorted(c))
                    ][0]
                )
            )
